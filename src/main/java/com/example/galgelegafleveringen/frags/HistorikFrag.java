...
public class HistorikFrag extends Fragment {
    ...
    public View onCreateView(LayoutInflater i, ViewGroup container, Bundle SavedInstanceState) {
        ...
        View rod = i.inflate(R.layout.activity_historik, container, false);
        mainActivity = (MainActivity) getActivity();

        sp = mainActivity.getApplicationContext().getSharedPreferences("vinderPrefs", Context.MODE_PRIVATE);
